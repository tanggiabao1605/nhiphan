...
export default function Home() {
    ...
    const [showDiagram, setShowDiagram] = useState(true); // Thêm state này
    ...
    const resetOperands = () => {
        ...
        setErrorMessageB("");
        setResult(null);
        setShowDiagram(true); // Đặt lại hình ảnh về trạng thái ban đầu
    };
    ...
    const handleCalculate = () => {
        // Ẩn hình ảnh trước khi tính toán
    ...
    return (
        <div className="min-h-screen p-10 bg-gray-100">
            <h1 className="text-4xl font-bold mb-10 text-center">Cộng Trừ Nhân Chia Số Nhị Phân</h1>
